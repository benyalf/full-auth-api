...
if DEVELOPMENT_MODE == True:
    ...
    AWS3_REGION_NAME = getenv("AWS3_REGION_NAME")
    AWS3_ENDPOINT_URL = f'https://${AWS3_REGION_NAME}.digitaloceanspaces.com'
...
SOCIAL_AUTH_GOOGLE_OAUTH2_EXTRA_DATA = ['firs-name', 'last-name']
...
CORS_ALLOWED_ORIGINS = getenv(
    "CORS_ALLOWED_ORIGINS", "http://localhost:8080,http://127.0.0.1:8080").split(",")
